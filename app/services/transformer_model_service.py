...
from app.transformer_model.transformer_code import TransformerClassifier
import torch
import os
import numpy as np
...
model_path_pth = os.path.join(BASE_DIR, "../transformer_model/transformer_best_model.pth")
